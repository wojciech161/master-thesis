...
classification method there is used an Euclidean distance. In the literature methods using 
Mahalanobis distance are also proposed\cite{mahalanobisConclusionsCite}. It is a good direction for
further research. Additionaly,
pre-analysis of the input map can be added to eliminate, or at least reduce
